...
`Prezentacja/prezentacja.html` (open directly in a browser, arrow-key/swipe
navigation) for the full write-up (slides 10-11) — source content also kept
as `Prezentacja/prezentacja.md`.
...
Prezentacja/prezentacja.html   project presentation, browser slide deck (open directly, no server needed)
Prezentacja/prezentacja.md     same content as plain Markdown (source / GitHub-readable)
```
